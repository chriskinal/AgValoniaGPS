...
using AgValoniaGPS.Desktop.Views.Panels.FieldOperations;
using System;

namespace AgValoniaGPS.Desktop.Views.Controls.DockButtons;

/// <summary>
/// Dockable button for the Tram Line panel.
/// </summary>
public partial class FormTramLineButton : UserControl
{
    private FormTramLine? _panel;
    private bool _isActive;

    public FormTramLineButton()
    {
        InitializeComponent();
    }
