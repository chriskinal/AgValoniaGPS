...
/// <summary>
/// Dockable button for the Roll Correction panel.
/// </summary>
public partial class FormRollCorrectionButton : UserControl
{
    private readonly IPanelHostingService _panelHostingService;
    private const string PanelId = "rollCorrection";

    public FormRollCorrectionButton(IPanelHostingService panelHostingService)
    {
