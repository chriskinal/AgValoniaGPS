...
/// <summary>
/// Dockable button for the Camera panel.
/// </summary>
public partial class FormCameraButton : UserControl
{
    private readonly IPanelHostingService _panelHostingService;
    private const string PanelId = "camera";

    public FormCameraButton(IPanelHostingService panelHostingService)
    {
