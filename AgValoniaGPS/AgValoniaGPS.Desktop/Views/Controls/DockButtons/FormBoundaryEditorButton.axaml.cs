...
/// <summary>
/// Dockable button for the Boundary Editor panel.
/// </summary>
public partial class FormBoundaryEditorButton : UserControl
{
    private readonly IPanelHostingService _panelHostingService;
    private const string PanelId = "boundaryEditor";

    public FormBoundaryEditorButton(IPanelHostingService panelHostingService)
    {
