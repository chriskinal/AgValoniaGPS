...
/// <summary>
/// Dockable button for the Flags panel.
/// </summary>
public partial class FormFlagsButton : UserControl
{
    private readonly IPanelHostingService _panelHostingService;
    private const string PanelId = "flags";

    public FormFlagsButton(IPanelHostingService panelHostingService)
    {
