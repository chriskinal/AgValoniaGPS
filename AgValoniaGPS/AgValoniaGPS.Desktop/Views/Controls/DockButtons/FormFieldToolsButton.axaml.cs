...
/// <summary>
/// Dockable button for the Field Tools panel.
/// </summary>
public partial class FormFieldToolsButton : UserControl
{
    private readonly IPanelHostingService _panelHostingService;
    private const string PanelId = "fieldTools";

    public FormFieldToolsButton(IPanelHostingService panelHostingService)
    {
